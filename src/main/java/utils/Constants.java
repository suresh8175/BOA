...
public class Constants {
	...
	public static final String CREATE_ACCOUNT_PAGE_URL		= "https://uat-portal.boa.co.nz/createAccount";
	public static final String CREATE_ACCOUNT_PAGE_TITLE	= "Complete the registration to create customer account";
